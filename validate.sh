...
check "output/documents/ exists"         "[ -d output/documents ]"
check "output/data_model/ exists"         "[ -d output/data_model ]"
check "output/db_entity_relations/ exists" "[ -d output/db_entity_relations ]"
check "output/postman_collection/ exists" "[ -d output/postman_collection ]"
check "output/api_document/ exists"       "[ -d output/api_document ]"
